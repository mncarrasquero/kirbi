/*
  # Fix Policy Conflicts and Enable Public Access to Materials

  1. Changes
    - Drop all existing policies
    - Create new policies with public access for materials table
...
-- Temporarily disable RLS on materials table to ensure data access
...
-- Create new policies for inventory_entries
